...
namespace ApiSdk.V1.Orders
{
    ...
    {
        /// <summary>Gets an item from the ApiSdk.v1.orders.item collection</summary>
        /// <param name="position">The order ID.</param>
        /// <returns>A <see cref="global::ApiSdk.V1.Orders.Item.OrdersItemRequestBuilder"/></returns>
        public global::ApiSdk.V1.Orders.Item.OrdersItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new global::ApiSdk.V1.Orders.Item.OrdersItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.V1.Orders.OrdersRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ListResource_Order_"/></returns>
...
#nullable enable
        public async Task<global::ApiSdk.Models.ListResource_Order_?> GetAsync(Action<RequestConfiguration<global::ApiSdk.V1.Orders.OrdersRequestBuilder.OrdersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ApiSdk.Models.ListResource_Order_> GetAsync(Action<RequestConfiguration<global::ApiSdk.V1.Orders.OrdersRequestBuilder.OrdersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ApiSdk.Models.ListResource_Order_>(requestInfo, global::ApiSdk.Models.ListResource_Order_.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List orders.**Scopes**: `orders:read`
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.V1.Orders.OrdersRequestBuilder.OrdersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.V1.Orders.OrdersRequestBuilder.OrdersRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.V1.Orders.OrdersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ApiSdk.V1.Orders.OrdersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ApiSdk.V1.Orders.OrdersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List orders.**Scopes**: `orders:read`
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class OrdersRequestBuilderGetRequestConfiguration : RequestConfiguration<global::ApiSdk.V1.Orders.OrdersRequestBuilder.OrdersRequestBuilderGetQueryParameters>
        {
        }
    }
}
